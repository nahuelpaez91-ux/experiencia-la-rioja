...
export default function MPConnectSection() {
    ...
    return (
        <div style={{
            ...
            border: `1px solid ${connected ? "#4E6B3A" : "#FCD34D"}`,
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                <div style={{
                    width: 44, height: 44, borderRadius: 12, backgroundColor: "#009EE3",
                ...
                <div>
                    ...
                    {connected
                        ? <div style={{ fontSize: 13, color: "#4E6B3A", marginTop: 2 }}>✅ Cuenta conectada — listo para recibir pagos</div>
                        : <div style={{ fontSize: 13, color: "#D07A2D", marginTop: 2 }}>⚠️ No conectado — necesario para recibir pagos</div>
                    }
                    {success && <div style={{ fontSize: 12, color: "#4E6B3A", marginTop: 4 }}>🎉 ¡Conectado exitosamente!</div>}
            ...
            {connected ? (
                ...
                <button onClick={handleConnect} style={{
                    backgroundColor: "#009EE3", color: "#fff", border: "none",
                    borderRadius: 10, padding: "9px 18px", fontSize: 13, fontWeight: 700, cursor: "pointer",
